   <?php
    include "php-backend/initialize.php";
   ...
   <head>
       ...
       <?php
        include "php-backend/font-family-page-fontload.php";
       ...
       <div class="container">
           ...
           <div id="title-container">
               ...
               <div class="font-family-button-container">
                   ...
                   <form action="fork.php" method="get" enctype="multipart/form-data">
                       ...
                       echo'
                       <input type="submit" value="Fork →" class="font-family-download-button">
';
                       }
                       ?>
                   </form>
           ...
           <div id="main-container">
               ...
               <div class="font-holder">
                   <form class="font">
                       ...
                       <input class='typeable family-name' type='text' name='text' placeholder='The five boxing wizards jump quickly'>
               ...
               <div class="sizing-attributes">
                   <div class="font-family-slider-container">
                       ...
                       <label class="font-family-slidecontainer" for="italicize">
                           ...
                           <div class="margin-left-lv2">
                               <h4>
                                   <?php
                                    ...
                                    //     $designerName = $designer_name['display_name'];
                                    //     echo $designerName;
                                    // }
                                    assoc_fetcher_echoer($fontdesigner, 'display_name');
                                    ?>
                               </h4>
                           </div>
                       </div>
